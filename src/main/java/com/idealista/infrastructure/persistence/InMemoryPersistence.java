...
import com.idealista.infrastructure.api.model.vo.PictureVO;
...
public class InMemoryPersistence {
    ...
    public InMemoryPersistence() {
        ...
        pictures.add(new PictureVO(1, "http://www.idealista.com/Picture/1", "SD"));
        pictures.add(new PictureVO(2, "http://www.idealista.com/Picture/2", "HD"));
        pictures.add(new PictureVO(3, "http://www.idealista.com/Picture/3", "SD"));
        pictures.add(new PictureVO(4, "http://www.idealista.com/Picture/4", "HD"));
        pictures.add(new PictureVO(5, "http://www.idealista.com/Picture/5", "SD"));
        pictures.add(new PictureVO(6, "http://www.idealista.com/Picture/6", "SD"));
        pictures.add(new PictureVO(7, "http://www.idealista.com/Picture/7", "SD"));
        pictures.add(new PictureVO(8, "http://www.idealista.com/Picture/8", "HD"));
    }
